...
extern RECEIVER *create_pure_signal_receiver(int id, int buffer_size,int sample_rate);
...
extern void add_ps_iq_samples(RECEIVER *rx, double i_sample_0,double q_sample_0, double i_sample_1, double q_sample_1);
