...
static struct {
  ...
  const char *str;
	...
	{ SWAP_RX,		"SWAPRX"},
	{ SWAP_VFO,		"SWAPVFO"},
	{ TOOLBAR_MOX_TUNE,	"TOOLBARMOX"},
	{ TOOLBAR_S1,		"TOOLBARS1"},
	{ TOOLBAR_S2,		"TOOLBARS2"},
	{ TOOLBAR_S3,		"TOOLBARS3"},
	{ TOOLBAR_S4,		"TOOLBARS4"},
	{ TOOLBAR_S5,		"TOOLBARS5"},
	{ TOOLBAR_S6,		"TOOLBARS6"},
	{ TOOLBAR_FUNCTION,	"TOOLBARFUNCTION"},
        { MIDI_TUNE,    	"TUNE"},
        { VFOA,         	"VFOA"},
        { VFOB,         	"VFOB"},
